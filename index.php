        ...
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-dark bg-dark">
                    <a href="index.php" class="navbar-brand">人には優しくしようよ</a>
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-light" href="create.php">つぶやく</a>
                        </li>
                        <?php
                        if(isset($curretUser))
                        {
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-right d-flex justify-content-end">
                                <a href="edit.php?id=<?= h($task['id']); ?>" class="btn text-success">書き換える</a>
